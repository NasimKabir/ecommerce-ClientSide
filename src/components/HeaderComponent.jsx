                ...
                <div id="slider-carousel" className="carousel slide" data-ride="carousel">
                  ...
                  <div className="carousel-inner">
                    <div className="item active">
                      ...
                      <div className="col-sm-6">
                        <img src="asset/images/home/girl1.jpg" className="girl img-responsive" alt="" />
                        <img src="asset/images/home/pricing.png" className="pricing" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="col-sm-6">
                      ...
                      <div className="col-sm-6">
                        <img src="asset/images/home/girl2.jpg" className="girl img-responsive" alt="" />
                        <img src="asset/images/home/pricing.png" className="pricing" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      ...
                      <div className="col-sm-6">
                        <img src="asset/images/home/girl3.jpg" className="girl img-responsive" alt="" />
                        <img src="asset/images/home/pricing.png" className="pricing" alt="" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-sm-4">
                    <div className="product-image-wrapper">
                      <div className="single-products">
                        ...
                        <img src="asset/images/home/new.png" className="new" alt="" />
                      </div>
                      <div className="choose">
                        <ul className="nav nav-pills nav-justified">
                          <li><a href="#"><i className="fa fa-plus-square" />Add to wishlist</a></li>
                  ...
                  <div className="col-sm-4">
                    <div className="product-image-wrapper">
                      <div className="single-products">
                        ...
                        <img src="asset/images/home/sale.png" className="new" alt="" />
                      </div>
                      <div className="choose">
                        <ul className="nav nav-pills nav-justified">
                          <li><a href="#"><i className="fa fa-plus-square" />Add to wishlist</a></li>
